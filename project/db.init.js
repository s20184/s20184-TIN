...
module.exports.volunteer1 = "INSERT INTO VOLUNTEERS VALUES ('John', 'Doe', '1995-01-01', '2022-01-01', 'john.doe@email.com', '123456789'); ";
module.exports.volunteer2 = "INSERT INTO VOLUNTEERS VALUES ('Jane', 'Doe', '1994-01-01', '2022-01-02', 'jane.doe@email.com', '987654321'); ";
module.exports.breed1 = "INSERT INTO BREEDS VALUES ('german shepherd', 'large, agile, muscular dog of noble character and high intelligence', 0); ";
module.exports.breed2 = "INSERT INTO BREEDS VALUES ('european shorthair', 'typical domestic cat of Europe', 0); ";
module.exports.pet1 = "INSERT INTO PETS VALUES (1, 'Hank the Tank', 'an obese male dog, acquired by the means of intervention at negligent home', '2022-02-01', 0); ";
module.exports.pet2 = "INSERT INTO PETS VALUES (2, 'Katishia', 'a mellow-tempered female cat', '2022-02-02', 1); ";
module.exports.task1 = "INSERT INTO TASKS VALUES (1, 2, 'bathe', 'bathe the dog on premises', '2022-03-03'); ";
module.exports.task2 = "INSERT INTO TASKS VALUES (2, 1, 'take photos', 'take photos of the animal for social media purposes', '2022-03-5'); ";